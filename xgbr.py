...
lin = linear_model.Lasso().fit(train_X,train_Y)
fsel_model = SelectFromModel(lin,prefit=True)

print(train_X.shape)
print(test_X.shape)
print(train_Y.shape)

train_X = fsel_model.transform(train_X)
test_X = fsel_model.transform(test_X)
